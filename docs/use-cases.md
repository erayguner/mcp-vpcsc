...
2. Scans all enabled APIs against 216 known VPC-SC supported services
...
- [MCP Server Guide](mcp-server-guide.md) — full reference for all 40 tools, 6 resources, and 3 prompts
